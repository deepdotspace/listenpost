...
seed_mention 'reddit|r1|Anyone using Octolens for brand monitoring? Worth the price?|Evaluating a few social listening tools for our devtools startup. Octolens keeps coming up — how is the relevance filtering in practice?|u/throwaway_dev|high|0.92|neutral|[\"buying_intent\",\"question\"]|new|{\"points\":142,\"comments\":38}|2|NULL'
seed_mention 'bluesky|b1|just switched from Mention to Octolens|half the mentions I used to triage manually never even reach me now. relevance scoring is doing its job.|@maria.bsky|high|0.89|positive|[\"praise\",\"comparison\"]|new|{\"likes\":56}|3|NULL'
...
seed_mention 'reddit|r2|Is Octolens overkill for a solo founder?|I only track one brand term. Wondering if the free tier covers enough or if I should just use Google Alerts.|u/indie_maker|medium|0.55|neutral|[\"question\"]|new|{\"points\":34,\"comments\":11}|28|NULL'
